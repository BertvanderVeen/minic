...
static const R_CallMethodDef CallEntries[] = {
    {"_rnewt_rnewt", (DL_FUNC) &_rnewt_rnewt, 27},
    {NULL, NULL, 0}
};

RcppExport void R_init_rnewt(DllInfo *dll) {
